...
<script type="text/javascript" src="bootstrap/js/jquery.min.js"></script>
	...
	<div class="contenedor">
		<div class="logo">
			<h1>JACK</h1>
				<h5>Trabajando unidos en Comunidad</h5>
		</div>
		
		<div class="logobta">
			<img alt="bogota" src="bootstrap/img/bogota.jpg" width="80%" height="60%">
		</div>
		...
		<div class="cierresesion">
			<a href="cerrarsesion.jsp" class="sesioncerrar">Cerrar Sesion</a>
		</div>
